...
<main>
    ...
    <section class="filter-section">
        ...
        <?php
// Fonction pour récupérer les années uniques depuis les métadonnées des posts
function get_unique_years() {
    global $wpdb;
    $years = $wpdb->get_col("SELECT DISTINCT YEAR(meta_value) FROM $wpdb->postmeta WHERE meta_key = 'date_meta' ORDER BY meta_value DESC");
    return $years;
}
